...
public class SeckillServiceImpl implements SeckillService {
     ...
     * 活动，特价，限量100000份
     */
    private static Map<String, Integer> products;//模拟商品信息表
    private static Map<String, Integer> stock;//模拟库存表
    private static Map<String, String> orders;//模拟下单成功用户表
